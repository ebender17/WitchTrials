...
namespace WT.Pool
{
    ...
    public abstract class ComponentPoolSO<T> : PoolSO<T> where T : Component
    {
        ...
        /// <remarks> NOTE: Setting the parent to an object marked DontDestroyOnLoad will effectively make this pool DontDestroyOnLoad. </remarks>
...
public class ComponentPoolSO : MonoBehaviour
{
